  ...
  (test-suite "a7"
    ...
    (test-suite "lex" 
      (test-equal-if-defined lex
        ...
        ((lex '(let/cc k 5) '()) '(let/cc (const 5)))
        ((lex '(let/cc k (throw k 5)) '()) '(let/cc (throw (var 0) (const 5))))
        ((lex '(let/cc k (throw k (* 5 5))) '()) '(let/cc (throw (var 0) (mult (const 5) (const 5)))))
        ((lex '(let/cc k (throw k (((lambda (x) x) k) (* 5 5)))) '()) 
         '(let/cc
           (throw
            (var 0)
            (app (app (lambda (var 0)) (var 0)) (mult (const 5) (const 5))))))
        ((lex '(let/cc k (sub1 (throw k 5))) '()) '(let/cc (sub1 (throw (var 0) (const 5)))))
        ((lex '(let/cc k (throw (throw k 5) 6)) '()) 
         '(let/cc (throw (throw (var 0) (const 5)) (const 6))))
        ((lex '(let/cc k (throw 5 (throw k 5))) '())
         '(let/cc (throw (const 5) (throw (var 0) (const 5)))))
        ((lex '(* 3 (let/cc k (throw 5 (throw k 5)))) '())
         '(mult (const 3) (let/cc (throw (const 5) (throw (var 0) (const 5))))))
        ((lex '(lambda (a)
                 (lambda (b)
                   (lambda (c)
                     (lambda (a)
    ...
    (test-suite "value-of-cps"
      (test-equal-if-defined value-of-cps
        ...
        ((value-of-cps '(let/cc (const 5)) (empty-env) (empty-k)) 5)
        ((value-of-cps '(let/cc (throw (var 0) (const 5))) (empty-env) (empty-k)) 5)
        ((value-of-cps '(let/cc (throw (var 0) (mult (const 5) (const 5)))) (empty-env) (empty-k)) 25)
        ((value-of-cps '(let/cc (throw (app (lambda (var 0)) (var 0)) (mult (const 5) (const 5)))) (empty-env) (empty-k)) 25)
        ((value-of-cps '(let/cc (sub1 (throw (var 0) (const 5)))) (empty-env) (empty-k)) 5)
        ((value-of-cps '(let/cc (throw (throw (var 0) (const 5)) (const 6))) (empty-env) (empty-k)) 5)
        ((value-of-cps '(let/cc (throw (const 5) (throw (var 0) (const 5)))) (empty-env) (empty-k)) 5)
        ((value-of-cps '(mult (const 3) (let/cc (throw (const 5) (throw (var 0) (const 5))))) (empty-env) (empty-k)) 15)
